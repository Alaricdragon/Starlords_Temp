...
public class shipCompositionCiv_Fuel implements LordBaseDataBuilder {
    @Override
    public boolean shouldGenerate(Lord lord, JSONObject json) {
        DataHolder a = lord.getMemory().getDATA_HOLDER();
        return !a.getBoolean(availableShipsCiv_Fuel.hasLoadedJSonKey);
    }
    ...
    public void generate(Lord lord) {
        ...
        AvailableShipData ships = (AvailableShipData) lord.getMemory().getDATA_HOLDER().getObject(availableShipsCiv_Fuel.fleetMemoryKey);
