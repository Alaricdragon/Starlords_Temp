...
public class shipCompositionCiv_Personal implements LordBaseDataBuilder {
    ...
    public boolean shouldGenerate(Lord lord, JSONObject json) {
        ...
        return !a.getBoolean(availableShipsCiv_Personal.hasLoadedJSonKey);
    }
    ...
    public void generate(Lord lord) {
        ...
        AvailableShipData ships = (AvailableShipData) lord.getMemory().getDATA_HOLDER().getObject(availableShipsCiv_Personal.fleetMemoryKey);
        ...
        lord.getMemory().setCompressed_Object(FLEETCOMP_PERSONAL, data);
    }
