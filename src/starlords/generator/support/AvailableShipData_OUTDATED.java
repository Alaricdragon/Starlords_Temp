...
@Deprecated
public class AvailableShipData_OUTDATED {
    ...
    @Getter
    private static AvailableShipData_OUTDATED defaultShips;
    private static HashMap<String, AvailableShipData_OUTDATED> factionShips;
    @Getter
    ...
    private static Logger log = Global.getLogger(AvailableShipData_OUTDATED.class);
    public AvailableShipData_OUTDATED(){
    ...
    @Deprecated
    public static AvailableShipData_OUTDATED getNewASD(Set<String> hullIds, boolean vareants){
        if (vareants) return getNewASDFromVariants(hullIds,defaultShips);
        return getNewASDFromHulls(hullIds,defaultShips);
    }
    @Deprecated
    public static AvailableShipData_OUTDATED getNewASDFromVariants(Set<String> variantIDs, AvailableShipData_OUTDATED AvailableShips){
        ...
        AvailableShipData_OUTDATED b = new AvailableShipData_OUTDATED();
    ...
    @Deprecated
    public static AvailableShipData_OUTDATED getNewASDFromHulls(Set<String> hullIds, AvailableShipData_OUTDATED AvailableShips){
        //log.info("DEBUG: attempting to get a new ASD with hullIds, AvailableShips: "+hullIds.size()+", "+AvailableShips.getUnorganizedShips().size());
        AvailableShipData_OUTDATED b = new AvailableShipData_OUTDATED();
    ...
    public static void startup(){
        ...
        defaultShips = new AvailableShipData_OUTDATED();
    ...
    private static void test2(String key){
        Logger log = Global.getLogger(AvailableShipData_OUTDATED.class);
    ...
    public void addHullsWithoutPriority(FactionAPI fac,String... type){
        fac.getOverriddenHulls();
        fac.getRestrictToVariants();
        fac.getVariantOverrides();
        fac.getVariantsForRole("");

    }
    public void addFacOnlyVariantsWithoutPriority(FactionAPI fac,String... type){

    }
    public AvailableShipData_OUTDATED getAvailableShipsForFaction(String factionID, String... type){
        AvailableShipData_OUTDATED out = new AvailableShipData_OUTDATED();
        /*for (String a : type){
            out.addListShips(organizedShips.get(a).get(a).values(),a);
        }*/
        /*
            Set<String> a = null;
        ...
        */
        ...
        /*so changes that need to be made here:
        1: variants weight needs to be overridden by the factions primary variant weight
        2: variants without proper data in default ship rules needs to just take there ship rules at face value.
        3: for ShipData, and its data holders:
            Ship data needs to change. Right now, it holds a list of all available variants. This is not acceptable.
            instead, it should hold a single varient, and its weight.
            effectivly just a hashmap.
