...
public class DialogValue_MemoryData_list extends DialogValue_base{
    ArrayList<DialogValue_base> values = new ArrayList<>();
    @SneakyThrows
    public DialogValue_MemoryData_list(JSONObject json, String key) {
        super(json, key);
        ...
        for (Iterator it2 = json2.keys(); it2.hasNext();) {
            ...
            values.add(new DialogValue_MemoryData(json2,key2));
        }
    }
