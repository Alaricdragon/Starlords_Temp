...
public class Constants {
    ...
    public static final String PMC_ADDITIONAL_MEMORY_KEY= "$STARLORDS_PMC_LORD_ADDITIONAL_MEMORY_";
    public static final String PMC_COMPRESSED_MEMORY_KEY= "$STARLORDS_PMC_LORD_COMPRESSED_MEMORY_";
