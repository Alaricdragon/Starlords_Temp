...
public class Constants {
    ...
    public static final String STARLORD_STRING_FLEETNAMES_MEMORY_KEY = "$STARLORDS_STRING_FLEETNAME_MEMORY";
    ...
    public static final String PMC_ADDITIONAL_MEMORY_KEY= "$STARLORDS_PMC_ADDITIONAL_MEMORY_";
    public static final String PMC_COMPRESSED_MEMORY_KEY= "$STARLORDS_PMC_COMPRESSED_MEMORY_";
